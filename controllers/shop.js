...
exports.getProducts = (req, res, next) => {
    const page = +req.query.page || 1; // + converts to number
    let totalItems;
...
exports.getInvoice = (req, res, next) => {
    ...
    Order.findById(orderId)
        .then(order => {
            ...
            res.setHeader(
                'Content-Disposition',
                'inline; filename="' + invoiceName + '"' // attachment instead of inline for download it 
            );
            pdfDoc.pipe(fs.createWriteStream(invoicePath)); // file generated on the fly
            pdfDoc.pipe(res);
